...
Original texts are quite long. ASoIaF consists of around 1.7 million words, while the HP series is a bit shorter, with 1.1 million words. Therefore, we split the books into smaller chunks and summarized each of them. We tried a few different summarization language models from HuggingFace:

\begin{itemize}
	\item \texttt{bart-large-cnn}
	\item \texttt{google-t5/t5-large}
	\item \texttt{google/pegasus-xsum}
	\item \texttt{Falconsai/text\_summarization}
\end{itemize}
