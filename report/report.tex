...
% Article title
\PaperTitle{From Hogwarts to Westeros: Dialogue-Driven LLMs}
...
% Keywords
\Keywords{literary conversational agents, large language models, dialogue extraction, retrieval-augmented generation}
