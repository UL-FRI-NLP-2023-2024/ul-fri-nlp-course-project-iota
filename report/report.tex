...
Literacy in youth is in decline \cite{murray2021literacy}. Young people hate reading and rearly read recreationally. One way to motivate young people to read is to engage them in converstaional interaction with digital pedagogical agents. There are many papers discussing the benefits of pedagogical agents  \cite{nielen2018digital,alaimi2020pedagogical}, but none of them really describes the technical implementation details. The aim of this project is to provide technical implementation details for creating pedagogical agents.
